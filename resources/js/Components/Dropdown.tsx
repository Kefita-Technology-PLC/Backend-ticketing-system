...
const Content = ({ align = 'right', width = '48', contentClasses = 'py-1 bg-white dark:bg-gray-800', children }: PropsWithChildren<{ align?: 'left' | 'right'; width?: '48'; contentClasses?: string }>) => {
    ...
    return (
        <Link
            ...
            className={
                ...
                dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:bg-gray-700 ` + className
            }
        >
            {children}
        </Link>
